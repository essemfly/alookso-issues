...
import type { IssueMetaInfo } from '@/types/issues';
import CelebGroup from '@/components/AvatarGroup/CelebGroup';


type CardProps = IssueMetaInfo;
      ...
      >
        <div className="relative h-52 w-full">
          <ImageFallback
            ...
            alt={title}
            src={coverImage ?? 'https://i.namu.wiki/i/h6H17qjR7-_eLCo9gYWzPLc8oi4Kx1CbL2PaC1mVEm9F97f6_02_s22DtkIBdkFgGJErF3DFVHHMQwVtrfGhYQ.webp'}
            style={{
              background: "linear-gradient(180deg, rgba(0, 0, 0, 0.4) 21.35%, rgba(0, 0, 0, 0) 34.9%)"
            }}
            priority
            fill
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
          />
          <span className="text-white p-1 absolute top-2 left-2 font-extralight text-sm">{updatedAt}</span>
          <span></span>
        </div>
